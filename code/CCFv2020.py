...
def create_ccf2020_anatomical_template(input_dir, results_dir, library, scales=(10,)):
    ...
    template = AnatomicalTemplate(name="allen-adult-mouse-stpt-template", version="2020", scales=scales)
...
def create_ccf2020_annotation_set(input_dir, results_dir, library, scales=(10,)):
    ...
    terminology = library.get_parcellation_terminology("allen-adult-mouse-terminology", "2020")
...
def package_ccf2020(input_dir, output_dir, library, scales=(10,)):
    ...
    atlas = ParcellationAtlas(
        ...
        version="2020",
        anatomical_space=library.get_anatomical_space("allen-adult-mouse-ccf-stereotaxic-space", "2020"),
        anatomical_annotation_set=library.get_anatomical_annotation_set(
            "allen-adult-mouse-stereotaxic-annotation", "2020"
        ),
        parcellation_terminology=library.get_parcellation_terminology("allen-adult-mouse-terminology", "2020"),
    )
